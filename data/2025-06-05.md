...
TL;DR: This is the final remark on the replies received to my target paper in the Italian Journal of Linguistics.


<details>
  <summary>Details</summary>
Motivation: To summarize and conclude the discussion on the replies received for the target paper.

Method: Analyzing and summarizing the replies.

Result: Final remarks on the replies received.

Conclusion: Concluding the discussion on the replies to the target paper.
...
TL;DR: Introduce FailureSensorIQ, a benchmark for assessing LLMs in industrial scenarios, revealing performance fragility and knowledge gaps.


<details>
  <summary>Details</summary>
Motivation: To create a novel Multi-Choice Question-Answering (MCQA) benchmarking system that assesses LLMs' ability to reason and understand complex industrial scenarios.

Method: FailureSensorIQ benchmark evaluates LLMs using multiple lenses such as Perturbation-Uncertainty-Complexity analysis, Expert Evaluation study, Asset-Specific Knowledge Gap analysis, and ReAct agents with external knowledge-bases.

Result: Closed-source models like GPT-4 approach expert-level performance but show fragility in certain conditions. The benchmark reveals knowledge gaps and provides insights into improving LLM performance.

Conclusion: Closed-source models with strong reasoning capabilities perform well but are still fragile to perturbations and distractions. The FailureSensorIQ benchmark highlights knowledge gaps and provides tools for improving LLM performance.
...
TL;DR: HyperSteer improves language model steering by generating effective steering vectors using hypernetworks, outperforming current methods.


<details>
  <summary>Details</summary>
Motivation: To address the limitations of both unsupervised and supervised methods for steering language models.

Method: HyperSteer uses hypernetwork-based architectures to generate steering vectors conditioned on steering prompts and the internals of the steered LM.

Result: HyperSteer outperforms other methods when scaled with thousands of steering prompts, even on unseen prompts.

Conclusion: HyperSteer surpasses state-of-the-art activation steering methods and performs as well as steering-via-prompting.
...
TL;DR: One-shot Critique Fine-Tuning (CFT) is proposed to efficiently enhance the reasoning abilities of large language models.


<details>
  <summary>Details</summary>
Motivation: To find a more efficient way to unleash the reasoning potential of powerful base LLMs than reinforcement learning (RL) which is expensive and unstable.

Method: Construct critique data by collecting diverse model-generated solutions to a single problem and use teacher LLMs to provide detailed critiques. Fine-tune LLMs on the CFT data.

Result: Qwen and Llama family models show significant performance gains across diverse reasoning tasks after being fine-tuned with CFT data. The results are comparable to or even surpass the results from RL with 20x less compute.

Conclusion: One-shot Critique Fine-Tuning (CFT) is a simple, general, and compute-efficient approach to unleash the reasoning capabilities of modern LLMs.
...
TL;DR: This paper explores using large language models to automatically create ODRL usage policies from natural language instructions, showing up to 91.95% accuracy in knowledge graph generation.


<details>
  <summary>Details</summary>
Motivation: The motivation behind this study is to explore the use of large language models like GPT-4 for automatically generating usage policies in the W3C Open Digital Rights Language (ODRL) from natural language instructions.

Method: The method involves using the ODRL ontology and its documentation as a key component of the prompt. The researchers also propose heuristics for modifying the ODRL ontology and its documentation to facilitate the end-to-end knowledge graph construction process.

Result: The approach was evaluated within the context of dataspace, which refers to distributed infrastructures for reliable data exchange among multiple participating organizations in the cultural sector. A benchmark comprising 12 use cases of differing complexities was developed. The evaluation demonstrated high accuracy rates of up to 91.95% in the generated knowledge graph.

Conclusion: This study concludes that a carefully selected version of existing ontology documentation can effectively direct policy generation.
...
TL;DR: Introducing Hopscotch, a method to skip unnecessary attention blocks in large language models without significantly affecting performance.


<details>
  <summary>Details</summary>
Motivation: Not all attention blocks in modern causal language models are necessary for every task.

Method: Hopscotch, a method that identifies and skips attention blocks with least contributions to a task and adapts to preserve output quality.
...
Conclusion: Hopscotch is a simple yet effective method that can mitigate distribution shifts in hidden states caused by removing attention blocks without modifying model weights or requiring access to pretraining or instruction-tuning data.
...
TL;DR: This study investigates why different evaluations exist between AI-generated and human-written literary texts, suggesting that these differences stem more from reader interpretation than text quality itself.


<details>
  <summary>Details</summary>
Motivation: To understand why evaluations of AI vs human literary texts vary greatly.

Method: Extracting textual features, modeling reader preferences, analyzing preference space.

Result: Readers cluster into 'surface-focused' and 'holistic' profiles with differing priorities.

Conclusion: Reader-sensitive evaluation frameworks are needed for creative text generation.
...
TL;DR: This paper presents a cross-platform dataset of 30,000 posts related to violent threats and sub-types of violence. Machine learning analysis shows high classification accuracy across different platforms.


<details>
  <summary>Details</summary>
Motivation: To facilitate research into the understanding and detection of malicious content, including violence, by providing useful, high-quality data.

Method: Introducing a cross-platform dataset of 30,000 posts hand-coded for violent threats and sub-types of violence, and performing machine learning analysis with an existing dataset of violent comments from YouTube.

Result: High classification accuracy was achieved both by training on one dataset and testing on the other, and in a merged dataset condition.
...
TL;DR: A new method called 'Ask a Local' is introduced to detect hallucinations in large language models. It uses perplexity distribution divergence between language-specialized models to identify potentially wrong information. The method is multilingual, efficient, and does not require training or external data.


<details>
  <summary>Details</summary>
Motivation: To address the challenge of detecting hallucinations in large language models which generate plausible but factually incorrect information.

Method: The method computes divergence between perplexity distributions of language-specialized models to find potentially hallucinated spans. It selects computationally efficient models and works across different languages without adaptation.

Result: The method performs consistently across 14 languages with Intersection-over-Union (IoU) scores around 0.3 and similar Spearman correlation values. It especially excels in Italian and Catalan with IoU scores of 0.42 and 0.38, respectively.

Conclusion: This study presents an effective and scalable solution for multilingual hallucination detection in large language models.
...
TL;DR: This study proposes a 3M pipeline using MLLMs for disaster impact assessment, showing effectiveness in integrating image-text signals and correlating with seismic data, but performance varies with different factors.


<details>
  <summary>Details</summary>
Motivation: To address the challenges of limited ground sensors and delays in official reporting during rapid, fine-grained disaster damage assessment.

Method: A structured Multimodal, Multilingual, and Multidimensional (3M) pipeline that leverages multimodal large language models (MLLMs) to assess disaster impacts.

Result: Performance varies with language, epicentral distance, and input modality.

Conclusion: MLLMs can effectively integrate image-text signals and have a strong correlation with ground-truth seismic data.
...
TL;DR: This survey reviews recent work on using large language models (LLMs) in trajectory prediction, categorizing them into five directions.


<details>
  <summary>Details</summary>
Motivation: To integrate language-driven techniques into trajectory prediction to leverage the semantic and reasoning capabilities of LLMs.

Method: Categorizing recent work into five directions: (1) Trajectory prediction via language modeling paradigms, (2) Direct trajectory prediction with pretrained language models, (3) Language-guided scene understanding for trajectory prediction, (4) Language-driven data generation for trajectory prediction, (5) Language-based reasoning and interpretability for trajectory prediction.

Result: A comprehensive overview of the emerging field of integrating LLMs into trajectory prediction, analyzing representative methods and identifying open challenges.

Conclusion: This survey bridges natural language processing and trajectory prediction, offering a unified perspective on how language can enrich trajectory prediction.
...
TL;DR: A novel approach called DistRAG is developed to enable Large Language Models (LLMs) to retrieve relevant spatial information for tasks requiring spatial reasoning.


<details>
  <summary>Details</summary>
Motivation: LLMs lack reliable spatial reasoning capabilities, especially about distances, which is needed for tasks like POI recommendation and itinerary planning.

Method: DistRAG encodes geodesic distances between locations in a graph and retrieves a context subgraph related to the question.

Result: The method allows LLMs to answer distance-based reasoning questions they couldn't answer before.

Conclusion: DistRAG provides a flexible way to give LLMs a basic 'world model' to complement their linguistic knowledge.
...
TL;DR: This study examines how the OLMo-7B large language model evolves its factual knowledge representation during pre-training by analyzing the roles of its attention heads and feed-forward networks. Results indicate initial reliance on general-purpose components that later specialize, with attention heads showing higher turnover compared to FFNs. Name-based relations take longer to converge than location-based ones, illustrating the impact of task complexity on knowledge acquisition.


<details>
  <summary>Details</summary>
Motivation: Enhancing the interpretability and reliability of large language models by understanding how they acquire and store factual knowledge.

Method: Tracking the roles of attention heads and feed-forward networks in the OLMo-7B model during pre-training stages.

Result: LLMs initially rely on general-purpose components that become specialized as training advances. Some components are repurposed once reliable predictions are made, suggesting an adaptive learning process. Attention heads have higher turnover than FFNs, and location-based relations converge faster than name-based ones.

Conclusion: The study provides insights into the mechanism of knowledge formation in large language models, emphasizing the role of component specialization and task complexity.
...
TL;DR: This study investigates various methods for detecting toxic language in Persian, highlighting the influence of cultural context on cross-lingual transfer learning performance.


<details>
  <summary>Details</summary>
Motivation: Creating safer online environments by limiting the spread of harmful content in Persian.

Method: Comparing fine-tuning, data enrichment, zero-shot and few-shot learning, and cross-lingual transfer learning methods.

Result: Cultural context significantly affects the performance of transfer learning for toxic language detection.

Conclusion: Culturally similar languages yield better results in transfer learning for toxic language detection compared to culturally distinct ones.
...
TL;DR: Use large language models to detect Alzheimer's disease through patient-generated text by introducing a new demonstration selection strategy.


<details>
  <summary>Details</summary>
Motivation: Detect linguistic abnormalities in patients with Alzheimer's disease for early intervention.

Method: Use large language models with in-context learning and introduce a new demonstration selection strategy called Delta-KNN.

Result: Delta-KNN outperforms existing in-context learning baselines and even surpasses supervised classifiers in certain cases.

Conclusion: Delta-KNN is an effective method for AD diagnosis using patient-generated text and large language models.
...
TL;DR: APT是一种增强领域特定性能的新方法，利用自生成的弱数据进行迭代偏好训练，保持了模型的通用能力。实验表明APT在多个基准测试上优于现有方法。


<details>
  <summary>Details</summary>
Motivation: 保持大语言模型的通用能力的同时增强其领域特定性能是一个挑战。

Method: APT通过使用仅包含错误发生的样本以及少量检索到的相似样本进行针对性训练来实现这一目标。

Result: APT在LLama-2和Mistral-V0.3模型上通过多种基准测试验证了其有效性，显示出了优越的下游任务表现。

Conclusion: APT是一种有效的方法，可以提高领域特定性能而不损害模型的广泛适用性。
...
TL;DR: This paper introduces XAI-Guided Context-Aware Data Augmentation, a novel approach that uses Explainable AI (XAI) techniques to improve data augmentation for low-resource languages. It demonstrates improved accuracy in hate speech and sentiment analysis tasks compared to traditional methods.


<details>
  <summary>Details</summary>
Motivation: The scarcity of labeled data is a major challenge in developing robust AI models, especially for low-resource languages. Conventional data augmentation techniques often introduce noise, cause semantic drift, disrupt context, lack control, and result in overfitting.

Method: XAI-Guided Context-Aware Data Augmentation modifies less critical features while preserving task-relevant ones, using an iterative feedback loop to refine augmented data over multiple cycles based on explainability-driven insights and performance gains.

Result: XAI-SR-BT and XAI-PR-BT showed 6.6% and 8.1% improvements in accuracy on hate speech and sentiment analysis tasks, respectively, compared to the baseline using the Amharic dataset and XLM-R model. These methods outperformed existing techniques by 4.8% and 5%.

Conclusion: This study offers a more controlled, interpretable, and context-aware solution to data augmentation, overcoming limitations of existing methods and suggesting a new way to use XAI to enhance AI model training.
...
TL;DR: A novel method named EpiCoDe is introduced to improve model performance in data-scarcity scenarios without extra training.


<details>
  <summary>Details</summary>
Motivation: High cost of acquiring annotated data often prevents models from obtaining capabilities to tackle downstream tasks.

Method: Employ model extrapolation to enhance a finetuned model with its inferior version, and then adopt contrastive decoding to further reduce predicted errors.

Result: EpiCoDe consistently outperforms existing methods with significant and robust improvement.

Conclusion: A new theoretical framework is proposed to reveal the mechanism behind contrastive decoding in data-scarcity scenarios.
...
TL;DR: MedEditBench评估现有知识编辑方法在医学领域的有效性，发现当前方法仅实现浅层记忆，提出SGR-Edit显著改进。


<details>
  <summary>Details</summary>
Motivation: 评估现有知识编辑方法在医学领域的适用性，解决复杂医学场景下知识内化和泛化的挑战。

Method: 引入MedEditBench及其包含的新医学知识编辑基准和三种编辑范式；提出SGR-Edit利用模型推导的推理作为目标知识进行编辑。

Result: 当前知识编辑方法在新场景中泛化能力有限；SGR-Edit展现出显著改进。

Conclusion: 揭示了医学知识在大型语言模型中的定位，探讨了顺序编辑对演进知识的影响，为实际医学应用提供指导。
...
TL;DR: This paper proposes a new method using BERTScore and a multi-task RoBERTa-based regressor to effectively detect the level of human involvement in the generation process of AI-generated text.


<details>
  <summary>Details</summary>
Motivation: The current countermeasures for detecting AI-generated text lack robustness as they treat it as a binary classification task and overlook human involvement in the generation process.

Method: We propose using BERTScore as a metric to measure human involvement in the generation process and a multi-task RoBERTa-based regressor trained on a token classification task.

Result: Our method succeeded with an F1 score of 0.9423 and a regressor mean squared error of 0.004. It also showed some generalizability across generative models.

Conclusion: Our proposed method using BERTScore and a multi-task RoBERTa-based regressor can effectively detect the level of human involvement in the generation process.
...
TL;DR: SPRINT accelerates large language models by pruning unnecessary sublayers while maintaining accuracy.


<details>
  <summary>Details</summary>
Motivation: Accelerating large language models without sacrificing accuracy.

Method: Proposes SPRINT, which considers latency reduction and tunability of sublayers to select targets for pruning.

Result: SPRINT improves accuracy-speedup trade-off, with up to 23.88%p higher accuracy on zero-shot commonsense reasoning benchmarks than existing methods.

Conclusion: SPRINT is an effective sublayer pruning method for accelerating large language models.
...
TL;DR: This paper combines Deep Reinforcement Learning and Evolutionary Algorithms to address the issue of balancing exploration and exploitation in task-oriented dialogue systems.


<details>
  <summary>Details</summary>
Motivation: The high dimensionality of state and action spaces in task-oriented dialogue systems leads to local optima or poor convergence when using only Deep Reinforcement Learning.

Method: Innovative combination of the global search capabilities of Evolutionary Algorithms with the local optimization of Deep Reinforcement Learning, along with an elite individual injection mechanism for enhancing search efficiency.

Result: Experiments on four datasets showed improved performance and demonstrated the effectiveness of the proposed elite individual injection mechanism in reducing exploration time.

Conclusion: The proposed approach achieves an efficient integration of Evolutionary Algorithms and Deep Reinforcement Learning for task-oriented dialogue policy tasks.
...
TL;DR: TokAlign efficiently replaces and aligns vocabularies for LLMs, improving multilingual text processing and knowledge transfer.


<details>
  <summary>Details</summary>
Motivation: Inefficient tokenization slows down LLM training and generation, and mismatches in vocabulary hinder knowledge transfer between models.

Method: TokAlign learns a one-to-one mapping matrix for token IDs, rearranges model parameters, and progressively fine-tunes them for the new vocabulary.

Result: TokAlign reduces perplexity from 3.4e2 to 1.2e2 after initialization and boosts token-level distillation by 4.4% over sentence-level distillation.

Conclusion: The proposed TokAlign method improves multilingual text compression rates and vocabulary initialization for LLMs, enhancing model performance with fewer training steps.
...
TL;DR: Seed-Coder是一种新的开源大型语言模型系列，包括基座、指令和推理模型，用于生成代码预训练数据，减少人工干预，从而提高代码生成、完成、编辑、推理和软件工程任务的性能。


<details>
  <summary>Details</summary>
Motivation: 当前开源大型语言模型在代码预训练数据上依赖大量人力，如手工制作的过滤规则和人工标注的数据，这些方法存在可扩展性差、主观偏差和维护成本高等问题。

Method: Seed-Coder通过模型为中心的数据管道生成代码预训练数据，利用LLMs进行评分和过滤，并通过监督微调、偏好优化和长链推理强化学习来训练指令和推理模型。

Result: Seed-Coder在代码生成、完成、编辑、推理和软件工程任务中表现出色，达到了同类开源模型中的最先进水平，甚至超过了某些更大的模型。

Conclusion: Seed-Coder展示了在减少人工干预的情况下，利用LLMs生成高质量代码预训练数据的能力，为提升模型的通用智能提供了新的途径。
...
TL;DR: This paper introduces Go-Browse, a method for collecting large-scale web agent data via structured exploration, achieving better performance than existing methods.


<details>
  <summary>Details</summary>
Motivation: The lack of understanding of their environment by digital agents, such as getting lost in unfamiliar websites, motivates the need for better data collection methods.

Method: Go-Browse frames data collection as a graph search, allowing for efficient exploration and reuse of information across episodes.

Result: On the WebArena benchmark, fine-tuning a 7B parameter language model on the collected dataset achieved a success rate of 21.7%, outperforming GPT-4o mini and other sub-10B parameter models.

Conclusion: Go-Browse provides an effective way to collect diverse and realistic web agent data, leading to improved performance in web navigation tasks.
...
TL;DR: This paper presents a novel Debate and Reflect framework that orchestrates multi-turn debates between smaller models and stronger teacher models, which is followed by Tree-structured Direct Preference Optimization to efficiently leverage these debate logs. The approach improves smaller-model accuracy, robustness, and generalization.


<details>
  <summary>Details</summary>
Motivation: Current techniques struggle to yield substantial and lasting performance gains in distilling large language models into smaller ones.

Method: Debate and Reflect framework with multi-turn debates and Tree-structured Direct Preference Optimization.

Result: Significantly improves smaller-model accuracy, robustness, and generalization.

Conclusion: Our approach outperforms conventional baselines by a large margin.
...
TL;DR: Proposed Balanced Preference Optimization (BPO) to improve Large Language Models' performance in mathematical reasoning tasks by addressing the degraded chosen responses issue of Direct Preference Optimization (DPO).


<details>
  <summary>Details</summary>
Motivation: DPO neglects absolute reward magnitudes which can lead to degraded chosen responses and poor performance.

Method: Balanced Preference Optimization (BPO) with two key components: balanced reward margin and gap adaptor.

Result: BPO outperforms DPO and its variants in multiple mathematical reasoning tasks.

Conclusion: BPO effectively addresses the DCR issue of DPO and improves the performance of LLMs in mathematical reasoning tasks.
...
TL;DR: A framework named Skeleton-Guided Multi-Turn Dialogue Generation is proposed to improve cross-turn coherence in multi-turn instruction synthesis. A new dataset named ConsistentChat is constructed for model training.


<details>
  <summary>Details</summary>
Motivation: Current instruction data synthesis methods neglect cross-turn coherence, leading to context drift and reduced task completion rates in extended conversations.

Method: The framework includes two stages: Intent Modeling and Skeleton Generation. Intent Modeling captures the global structure of human dialogues, while Skeleton Generation constructs a structurally grounded sequence of user queries aligned with the modeled intent.

Result: Experiments on three benchmarks show that models fine-tuned on ConsistentChat achieve significant improvements in chat consistency and task success rate compared to models trained on existing datasets.

Conclusion: The proposed framework and dataset can effectively enhance the performance of multi-turn dialogue generation models.
...
TL;DR: 提出了一种新的方法PosS，通过使用专门处理特定位置的草稿层来提高大型语言模型推理的效率和准确性。


<details>
  <summary>Details</summary>
Motivation: 现有方法在后期位置的草稿token预测质量下降，因为草稿模型生成特征中的错误累积。

Method: 引入了位置专家（PosS），由多个专门处理特定位置的草稿层组成，每个专家专注于处理一定水平的草稿模型特征偏差。

Result: 实验结果表明，提出的PosS在Llama-3-8B-Instruct和Llama-2-13B-chat上对六个数据集的有效性。

Conclusion: 提出的位置专家（PosS）显著提高了后期位置的token接受率，并在多个数据集上有效改进了基准模型的平均接受长度和加速比。
...
TL;DR: Two advanced vision-language models achieve state-of-the-art performance through innovative training methods and comprehensive evaluation.


<details>
  <summary>Details</summary>
Motivation: To develop powerful vision-language models that excel in general visual understanding and multimodal reasoning.

Method: Four-stage pre-training with 2.4 trillion tokens combined with Mixed On-policy Reinforcement Learning (MORL).

Result: MiMo-VL-7B-RL outperforms other models including Qwen2.5-VL-7B on most tasks and achieves high scores on various benchmarks like OlympiadBench and OSWorld-G.

Conclusion: MiMo-VL-7B-SFT and MiMo-VL-7B-RL demonstrate superior performance in vision-language understanding and reasoning tasks.
...
TL;DR: 提出FreePRM框架，无需真实步级标签即可训练过程奖励模型（PRMs），通过最终结果正确性生成伪步级标签并利用缓冲概率消除噪声影响，实验显示其在ProcessBench上的F1分数平均达到53.0%，优于其他方法。


<details>
  <summary>Details</summary>
Motivation: 传统PRMs训练需要昂贵且难以大规模获取的步级标签。

Method: 引入FreePRM框架，包括基于最终结果正确性生成伪步级标签及使用Buffer Probability处理伪标签中的噪声。

Result: FreePRM在ProcessBench上取得53.0%的F1分数，比Math-Shepherd上完全监督的PRM高出24.1%，比其他开源PRMs高出至少10.9%。

Conclusion: 这项工作开创了PRM训练的新范式，大幅减少了对昂贵步级标注的依赖，同时保持了强劲性能。
...
TL;DR: Large language models often face limitations in comprehending problems. This paper introduces Exchange-of-Perspective (EoP), a framework designed to overcome these limitations by exchanging perspectives across different problem definitions. Extensive experiments demonstrate EoP's effectiveness, showing significant performance improvements.


<details>
  <summary>Details</summary>
Motivation: Addressing the inherent comprehension limitations of large language models in understanding diverse problem definitions.

Method: Proposing Exchange-of-Perspective (EoP), a novel framework aimed at exchanging perspectives across different problem definitions to break the fixed mindset from any particular formulation of the question.

Result: Significant performance improvements were observed on 8 benchmarks. For example, with GPT-3.5-Turbo and EoP, there was a 3.6% improvement on AQuA (from 60.6% to 64.2%). GPT-4-powered EoP showed a 7.7% overall accuracy enhancement on Math (from 53.9% to 61.6%) and a 3.5% improvement on OlympiadBench Maths (from 43.5% to 47.0%) when using Qwen-2.5-72b.

Conclusion: The proposed Exchange-of-Perspective (EoP) framework effectively improves the performance of large language models on various NLP tasks by addressing their comprehension limitations.
...
TL;DR: A bidirectional LM framework that fuses structural cues from KGs with the semantic expressiveness of generative transformers.


<details>
  <summary>Details</summary>
Motivation: Unify symbolic knowledge graphs with language models for richer semantic understanding.

Method: Introduces KG-BiLM with three key components: Bidirectional Knowledge Attention, Knowledge-Masked Prediction, and Contrastive Graph Semantic Aggregation.

Result: Outperforms strong baselines in link prediction, especially on large-scale graphs with complex multi-hop relations.

Conclusion: Effectively unifies structural information and textual semantics.
...
TL;DR: Use Pre-trained Language Models (PLMs) to generate example sentences for L2 Japanese learners. Evaluate the quality of sentences considering difficulty, diversity, and naturalness.


<details>
  <summary>Details</summary>
Motivation: Provide diverse and proficiency-aligned example sentences to promote effective language acquisition.

Method: 1. Use PLMs as quality scoring components in a retrieval system. 2. Use PLMs as direct sentence generators through zero-shot learning.

Result: Retrieval approach was preferred by all evaluators, especially for beginner and advanced proficiency. Generative approaches received lower scores on average.

Conclusion: PLMs have the potential to enhance the adaptability of sentence suggestion systems and improve language learning.
...
TL;DR: This work aims to reduce the computational burden of NLG benchmarks for LLMs by reformulating generative tasks into cheaper NLU alternatives, achieving strong correlations and significant time savings.


<details>
  <summary>Details</summary>
Motivation: Iterative evaluation of LLMs during training is important but costly, especially for NLG tasks like reasoning and code generation. The goal is to enable monitoring crucial LLM capabilities more efficiently.

Method: Reformulate generative tasks into cheaper NLU alternatives and test performance correlation between original and reformulated tasks.

Result: Strong correlation found between task formats with an average 35x reduction in evaluation time.

Conclusion: Capability assessment via cheaper alternatives is supported and plans to publish benchmark adaptions are made.
...
TL;DR: This paper compares linguistically-naive and linguistically-motivated data augmentation strategies for low-resource languages Uspanteko and Arapaho, finding that motivated strategies outperform naive ones only when the augmented data remains similar to the training data distribution.


<details>
  <summary>Details</summary>
Motivation: To systematically compare linguistically-naive and linguistically-motivated data augmentation strategies for low-resource languages and determine if the extra effort for motivated strategies improves downstream performance.

Method: Conducting a careful and comprehensive comparison of various data augmentation strategies for machine translation and interlinear glossing tasks using Uspanteko and Arapaho datasets.

Result: Linguistically-motivated strategies surpass naive approaches only when the augmented data is not significantly different from the training data distribution.

Conclusion: Linguistically-motivated data augmentation can be beneficial for low-resource languages if it maintains similarity to the original data distribution.
...
<details>
  <summary>Details</summary>
Motivation: The challenge of using resource-intensive open-source models in resource-constrained environments for Text-to-SQL translation.

Method: Decomposing the task into schema filtering, retrieval-augmented text-to-SQL generation, and prompt-driven schema linking and SQL generation. Fine-tuning large language models for schema selection accuracy and exploring the impact of prompt engineering with CoT and GoT templates.

Result: Comprehensive evaluations on the Spider benchmarks show the effectiveness of AP-SQL.

Conclusion: AP-SQL bridges the gap between resource-efficient small open-source models and powerful closed-source models for Text-to-SQL translation.
...
TL;DR: Incorporate a novel method called Dynamic Inserting Tokens Training (DIT) to improve the reasoning capabilities of transformer-based large language models.


<details>
  <summary>Details</summary>
Motivation: Previous works have explored incorporating special-purpose tokens into the training process to enhance the learning mechanism.

Method: Identify positions within sequences where model confidence is lowest and insert [PAUSE] tokens on these positions to bolster the model's predictive capabilities for subsequent tokens.

Result: Achieve accuracy gains of up to 4.7%p on GSM8K, 3.23%p on AQUA-RAT, and pass@1 improvements of up to 3.4%p on MBPP datasets.

Conclusion: This work demonstrates a model-based, dynamic approach to enhance reasoning capabilities rather than a heuristic one, broadening the scope of research in reasoning.
...
TL;DR: This study evaluates the cultural awareness of Large Language Models (LLMs) by introducing YokaiEval, a dataset of 809 multiple-choice questions about Japanese folklore. It finds that models trained on Japanese resources outperform English-centric ones.


<details>
  <summary>Details</summary>
Motivation: To address the lack of cultural knowledge of non-English speaking communities in LLMs, focusing on Japanese folklore as a medium for cultural expression.

Method: Developing YokaiEval, a benchmark dataset with questions about Japanese yokai, and evaluating 31 Japanese and multilingual LLMs.

Result: Japanese-trained models outperformed English-centric ones, with Llama-3 based models showing the best performance.

Conclusion: This research highlights the importance of culturally-aware training data for improving LLMs' understanding of non-English cultures.
...
TL;DR: A novel prompting strategy named RoP is proposed to enhance the robustness of Large Language Models (LLMs). It includes two stages: Error Correction and Guidance. Experiments show RoP improves LLMs' robustness against adversarial perturbations.


<details>
  <summary>Details</summary>
Motivation: To develop a prompting strategy that explicitly mitigates the negative impact of input perturbations on LLMs.

Method: RoP has two stages: Error Correction (generating adversarial examples and constructing prompts for error correction) and Guidance (generating optimal guidance prompting for robust and accurate inferences).

Result: RoP significantly improves LLMs' robustness against adversarial perturbations while maintaining high accuracy, even with minimal degradation compared to clean input scenarios.
...
TL;DR: Introduces RewardAnything, a novel reward model that can follow natural language principles, showing better adaptability and performance compared to existing models.


<details>
  <summary>Details</summary>
Motivation: Existing reward models are limited by their fixed preference datasets and lack the ability to adapt to diverse real-world needs.

Method: RewardAnything is trained to follow natural language principles, enabling it to adapt to various tasks and principles.

Result: RewardAnything outperforms current reward models in generalization and adaptability, achieving state-of-the-art performance.

Conclusion: RewardAnything shows superior adaptability in handling diverse real-world requirements without the need for retraining.
...
TL;DR: 本文综述了六个关键维度，用于评估基于大型语言模型的医疗问答系统的可信度，并提出了未来的研究方向。


<details>
  <summary>Details</summary>
Motivation: 确保患者安全、临床效果和用户信心，提高医疗问答系统的可靠性，直接关系到临床决策和患者结果。然而，由于医疗数据的复杂性、临床场景的重要性以及值得信赖的人工智能的多方面维度，实现全面的可信度存在重大挑战。

Method: 对现有的基于大型语言模型的医疗问答系统进行全面调查，重点考察其可信度的六个关键维度。

Result: 对六个关键维度进行了全面审查，包括如何在现有的基于大型语言模型的医疗问答系统中评估每个维度，编译和比较主要基准，并分析评估引导的技术。

Conclusion: 识别医疗问答中的事实性、鲁棒性、公平性、安全性、可解释性和校准性等六个关键维度，并分析现有评估这些维度的主要基准和引导模型改进的技术。最后，确定了可扩展的专家评估、综合多维指标和真实世界部署研究等开放挑战，并提出了未来的研究方向。
...
TL;DR: This paper introduces ROSA, a decoding strategy that improves VQA performance for text-rich images with incorrectly oriented text, addressing challenges faced by visually impaired individuals.


<details>
  <summary>Details</summary>
Motivation: Current VQA models struggle with recognizing text in photos taken by visually impaired individuals due to under-representation of incorrectly oriented text.

Method: Introduce ROSA, a decoding strategy

Result: ROSA outperforms Greedy decoding by 11.7 absolute points in the best-performing model.

Conclusion: ROtated SAmpling (ROSA) improves VQA performance in text-rich images with incorrectly oriented text.
...
TL;DR: This study explores data selection pipelines to improve ASR adaptation using Whisper and Zipformer models. It proposes an approach that filters pseudo-labels and integrates multiple selection strategies, achieving comparable performance with much smaller datasets.


<details>
  <summary>Details</summary>
Motivation: Small organizations face challenges in fine-tuning pretrained ASR models due to limited labeled data and computational resources.

Method: Proposes a robust approach integrating word error rate prediction, named entity recognition, and character error rate analysis to filter pseudo-labels generated by Whisper and Zipformer models.

Result: Fine-tuning on 7500 hours of pseudo-labeled data achieves 12.3% WER, while the proposed filtering reduces the dataset to 100 hours with similar performance.

Conclusion: The approach significantly reduces the required dataset size without sacrificing performance, making ASR adaptation more accessible for small organizations.
...
TL;DR: A dynamic target margin preference optimization algorithm named γ-PO is proposed to improve the alignment of large language models.


<details>
  <summary>Details</summary>
Motivation: Ensuring safety and reliability of large language models in practical applications.

Method: Introducing instance-specific margin calibration to adjust reward margins at the pairwise level.

Result: Improves average performance by 4.4% across benchmarks like AlpacaEval2 and Arena-Hard.
...
TL;DR: AdaDecode is a novel method for accelerating large language model decoding without requiring auxiliary models or changes to the original model parameters, while ensuring output consistency.


<details>
  <summary>Details</summary>
Motivation: Autoregressive decoding is inherently limited by its sequential token generation process, restricting the ability to fully leverage modern hardware's parallel processing capabilities.

Method: AdaDecode adaptively generates tokens at intermediate layers when confidence is high, enabling the next token's computation to begin immediately. The remaining layer computations for early-predicted tokens are deferred and executed in parallel with subsequent tokens when needed.

Result: Experiments show that AdaDecode consistently achieves superior decoding throughput with up to 1.73x speedup, while guaranteeing output parity with standard autoregressive decoding.

Conclusion: AdaDecode accelerates LLM decoding without requiring auxiliary models or changes to the original model parameters, while ensuring output consistency.
...
TL;DR: ScoreRAG是一种通过多阶段框架增强自动化新闻生成质量的方法，包括检索增强生成、一致性相关性评估和结构化总结。它旨在提高生成新闻文章的准确性、连贯性、信息量和专业性，并保持生成过程的稳定性和一致性。


<details>
  <summary>Details</summary>
Motivation: 当前新闻生成方法常出现幻觉、事实不一致以及缺乏领域专业知识等问题。

Method: ScoreRAG通过检索相关的新闻文档，使用大型语言模型进行一致性相关性评分，然后根据得分重排序并过滤低质量项目，最后基于得分生成分级摘要以指导大型语言模型生成完整的新闻文章。

Result: ScoreRAG提高了生成新闻文章的准确性、连贯性、信息量和专业性，同时保持了生成过程的稳定性和一致性。

Conclusion: ScoreRAG提供了一个有效的方法来解决当前新闻生成中的主要问题，从而提升新闻生成的质量。
...
TL;DR: This paper proposes a new prefix-to-prefix training framework using fine-tuned Whisper for streaming speech recognition. A Continuous Integrate-and-Fire mechanism and Monotonic Finite Look-ahead Attention are introduced to create a quasi-monotonic alignment between speech and text, with wait-k decoding for simplified processing. The method shows a balance between latency and quality.


<details>
  <summary>Details</summary>
Motivation: To reduce training costs for speech tasks and integrate large pre-trained models like Whisper into streaming systems.

Method: Fine-tuning Whisper with a prefix-to-prefix training framework, introducing Continuous Integrate-and-Fire and Monotonic Finite Look-ahead Attention, and using wait-k decoding strategy.

Result: The approach achieves a controllable trade-off between latency and quality, suitable for various streaming applications.

Conclusion: This work demonstrates the feasibility of integrating large pre-trained speech models into streaming systems with improved efficiency and performance.
...
TL;DR: This paper investigates uncertainty calibration in large language models (LLMs) for chain-of-thought (CoT) reasoning. It finds that supervised fine-tuning with scalar confidence labels can elicit self-verification behavior in LLMs, improving both calibration and accuracy while enhancing interpretability.


<details>
  <summary>Details</summary>
Motivation: Uncertainty calibration is crucial for safe deployment of LLMs, especially when relying on verbalized confidence estimates. Confidence calibration for CoT reasoning has been largely unexplored.

Method: Supervised fine-tuning with scalar confidence labels alone is used to elicit self-verification behavior in LLMs. A simple rethinking method is proposed to boost performance via test-time scaling based on calibrated uncertainty.

Result: Experiments on GSM8K and held-out reasoning tasks such as MATH-500 and ARC-Challenge show that the proposed confidence-aware fine-tuning improves both calibration and accuracy, while also enhancing interpretability by aligning the model's reasoning path with its confidence.

Conclusion: This work demonstrates that supervised fine-tuning with scalar confidence labels can be effective for confidence calibration in LLMs for CoT reasoning, leading to improved calibration, accuracy, and interpretability.
...
TL;DR: 提出了一种新的框架Math2Visual，用于自动生成数学应用题的教学上有意义的视觉效果，并建立了一个新的基准，同时指出了生成教育内容的关键挑战。


<details>
  <summary>Details</summary>
Motivation: 虽然视觉效果是教授数学应用题的重要工具，但创建它们需要大量的人力，而且缺乏自动化方法来支持这一过程。

Method: 提出了一种名为Math2Visual的自动框架，该框架利用预定义的视觉语言和设计空间来说明MWPs中的核心数学关系。使用Math2Visual构建了一个包含1,903个视觉效果的注释数据集，并评估了文本到图像（TTI）模型生成与设计相一致的视觉效果的能力。进一步微调了几种TTI模型，以展示在教育视觉生成方面的改进。

Result: 通过使用Math2Visual构建的数据集，评估并微调了几种TTI模型，展示了在教育视觉生成方面的改进。

Conclusion: 提出了一种新的基准，用于自动生成有教育意义的视觉效果，并提供了关于生成多模态教育内容的关键挑战的见解，例如数学关系的错误表示和重要视觉元素的遗漏。
...
TL;DR: This paper introduces Pet-Bench, a benchmark for evaluating Large Language Models' (LLMs) capabilities in providing comprehensive companionship in virtual pet applications.


<details>
  <summary>Details</summary>
Motivation: To explore the potential of LLMs in creating interactive and emotionally rich experiences through virtual pet companionship.

Method: Developing a benchmark named Pet-Bench that assesses LLMs' performance in self-interaction and human-interaction dimensions, emphasizing self-evolution and developmental behaviors.

Result: Evaluation of 28 LLMs showed significant performance variations related to model size and inherent capabilities, indicating the need for specialized optimization.

Conclusion: Pet-Bench is a foundational resource for benchmarking pet-related LLM abilities and advancing emotionally immersive human-pet interactions.
...
TL;DR: AhaKV提出一种新的方法来减少KV缓存的使用，通过自适应调整softmax尺度来解决累积注意力分数的偏差问题，并利用价值向量信息来优化适应性得分，从而在多个基准任务上实现了最先进的结果。


<details>
  <summary>Details</summary>
Motivation: 现有的减少KV缓存的方法依赖于累积注意力分数作为驱逐分数，但这种方法存在偏差，限制了模型对全局上下文信息的访问。

Method: 提出了一种名为AhaKV的新方法，通过自适应调整softmax尺度来解决累积注意力分数的偏差问题，并利用价值向量信息来优化适应性得分。

Result: 在固定缓存预算的不同模型上部署了AhaKV，实验表明AhaKV成功减轻了偏差并保留了全局上下文中的关键令牌，在几个基准任务上实现了最先进的结果。

Conclusion: AhaKV是一种有效的减少KV缓存的方法，可以提高大型语言模型的推理效率，同时保持模型的性能。
...
TL;DR: This paper proposes a new method called ClozeMath to improve mathematical reasoning in large language models by using a text-infilling task that predicts masked equations from a given solution.


<details>
  <summary>Details</summary>
Motivation: The conventional scheme of next-word prediction may not fully capture how humans learn to think, so the authors were inspired by how humans generalize mathematical reasoning.

Method: The authors use a text-infilling task that predicts masked equations from a given solution, similar to cloze exercises used in human learning.

Result: ClozeMath outperforms the strong baseline Masked Thought in performance and robustness on GSM8K, MATH, and GSM-Symbolic datasets with two test-time scaling decoding algorithms.

Conclusion: The proposed ClozeMath approach shows promise in improving mathematical reasoning in large language models.
...
TL;DR: Propose UniQuanF, a unified quantization method for large language models.


<details>
  <summary>Details</summary>
Motivation: To quantize large language models while maintaining accuracy.

Method: Unifies flexible mapping technique in UQ and non-uniform quantization levels of BCQ with proposed initialization and mapping techniques.

Result: Outperforms existing UQ and BCQ methods, improving accuracy by up to 4.60% on GSM8K benchmark.

Conclusion: UniQuanF removes computational and memory overhead, enabling superior accuracy without extra deployment costs.
...
TL;DR: This paper introduces Knockout Assessment, a new method using a knockout tournament system with iterative pairwise comparisons for LLM evaluation, which improves scoring accuracy compared to previous methods.
...
Method: Knockout Assessment uses a knockout tournament system with iterative pairwise comparisons.

Result: Experiments on three LLMs across two datasets showed that knockout assessment improved scoring accuracy, increasing Pearson correlation with expert evaluations.
...
TL;DR: A new punctuation restoration model called Cadence has been developed, which outperforms previous models and supports more languages.


<details>
  <summary>Details</summary>
Motivation: Current models struggle with restoring punctuation in spontaneous speech, especially with disfluencies, affecting downstream tasks.

Method: Cadence, a generalist punctuation restoration model adapted from a pretrained large language model.

Result: Cadence surpasses previous state-of-the-art performance and expands language support from 14 to 22 Indian languages plus English.

Conclusion: Using pretrained language models for multilingual punctuation restoration is effective and Cadence has practical value for low-resource NLP pipelines.
...
TL;DR: This paper introduces a method to automatically correct writing anomalies in Hausa texts using fine-tuned transformer-based models and a large-scale parallel dataset.


<details>
  <summary>Details</summary>
Motivation: The motivation is to address the challenges posed by writing anomalies in Hausa texts that hinder natural language processing applications.

Method: The method involves creating a large-scale parallel dataset of noisy-clean Hausa sentence pairs and adapting multilingual and African language-focused models for the correction task using SentencePiece tokenization.

Result: The experimental results show significant improvements in F1, BLEU, and METEOR scores, as well as reductions in CER and WER.

Conclusion: This research offers a robust methodology, a publicly available dataset, and effective models to enhance Hausa text quality and NLP capabilities for low-resource languages.
...
TL;DR: CRAWLDoc is a novel approach for ranking linked web documents based on context, starting from a publication's URL. It processes linked resources like PDFs and ORCID profiles into a unified representation and shows robust performance across different publishers and data formats.


<details>
  <summary>Details</summary>
Motivation: Variations in web layouts and data formats pose challenges for metadata extraction by publication databases.

Method: CRAWLDoc retrieves linked web resources starting from a publication URL, embeds them into a unified representation, and ranks them contextually.

Result: CRAWLDoc performs well in ranking relevant documents across publishers and formats, as demonstrated by evaluations using a manually labeled dataset of 600 publications.

Conclusion: This work establishes a foundation for enhanced metadata extraction from diverse web documents with varying layouts and formats.
...
TL;DR: 提出了一种多目标对齐出价词生成模型(MoBGM)，用于解决电子商务搜索广告中的长尾查询匹配问题，该模型由判别器、生成器和偏好对齐模块组成，旨在同时优化查询的相关性和真实性并最大化平台收入。实验表明，该算法显著优于现有技术，并在部署后为平台创造了巨大的商业价值。


<details>
  <summary>Details</summary>
Motivation: 现有的查询重写研究方法往往无法同时优化用户原始查询的相关性和真实性，也不能最大程度地提高召回广告的收入潜力。

Method: 提出了一种多目标对齐出价词生成模型(MoBGM)，包括判别器、生成器和偏好对齐模块，并设计了判别器来优化关键目标，利用判别器的反馈信号训练多目标对齐出价词生成器。

Result: 广泛的离线和在线实验显示，所提出的算法显著优于最先进的算法。在部署后，该算法为平台创造了巨大的商业价值。

Conclusion: MoBGM解决了电子商务搜索广告中的长尾查询匹配问题，同时优化了查询的相关性和真实性并最大化了平台收入，验证了其可行性和鲁棒性。
...
TL;DR: Brain-tuning improves speech models' semantic understanding and helps them reflect the brain's intermediate stages of speech processing.


<details>
  <summary>Details</summary>
Motivation: Pretrained self-supervised speech models do not reflect the hierarchy of human speech processing.

Method: Examine brain-tuned models' alignment with semantic language regions and conduct layer-wise probing.

Result: Late layers of brain-tuned models improve in aligning with semantic language regions and become better at complex high-level tasks.

Conclusion: Brain-tuned models not only perform better but also exhibit a well-defined hierarchical processing from acoustic to semantic representations.
...
TL;DR: This paper presents PulseReddit, a new dataset combining Reddit discussions with cryptocurrency market stats for high-frequency trading analysis. It uses LLM-based Multi-Agent Systems to show that this data improves trading results, especially in bullish markets, and offers insights into choosing LLMs for HFT.


<details>
  <summary>Details</summary>
Motivation: To explore the underused information from social media platforms like Reddit for high-frequency trading in cryptocurrency markets.

Method: Introduces PulseReddit dataset and uses LLM-based Multi-Agent Systems to study the effect of social sentiment from this data on trading performance.

Result: MAS with PulseReddit data shows better trading outcomes than traditional methods, especially in bull markets, and adapts well across different market conditions.

Conclusion: The research proves the value of integrating social media data in high-frequency trading and gives important insights for practical model selection in HFT applications.
...
TL;DR: This paper introduces EuroGEST, a dataset measuring gender-stereotypical reasoning in large language models across 30 European languages. It finds that all models exhibit strong gender stereotypes and larger models encode these stereotypes more strongly.


<details>
  <summary>Details</summary>
Motivation: Most benchmarks for gender bias in large language models are English-centric, but this paper aims to address this gap by creating a multilingual dataset.

Method: EuroGEST was created by expanding an existing expert-informed benchmark using translation tools, quality estimation metrics, and morphological heuristics. Human evaluations confirmed the accuracy of translations and gender labels.

Result: The study evaluated 24 multilingual language models and found that the strongest stereotypes were consistent across all languages and models, with larger models encoding gendered stereotypes more strongly. Instruction finetuning did not consistently reduce gendered stereotypes.

Conclusion: This work highlights the need for more multilingual studies of fairness in large language models and provides scalable methods and resources to audit gender bias across languages.
...
TL;DR: 提出了一种名为RadialRouter的新框架，用于大型语言模型（LLM）路由。该框架使用轻量级的RadialFormer来表达查询与LLMs之间的关系，并通过结合Kullback-Leibler散度与查询-查询对比损失的目标函数进一步优化了管道。实验结果显示，RadialRouter在平衡和成本优先场景中分别比现有方法提高了9.2％和5.8％。


<details>
  <summary>Details</summary>
Motivation: 当前LLM路由方法由于未能充分探索用户查询与LLMs特性之间的内在联系，在有效性上存在局限性。

Method: 提出了一种名为RadialRouter的新框架，使用RadialFormer来表达查询-LLMs关系，并通过目标函数增强鲁棒性。

Result: 在RouterBench上的实验表明，RadialRouter在平衡和成本优先场景中的性能显著优于现有方法。

Conclusion: RadialRouter展示了对不同性能-成本权衡和动态LLM池的适应性，具有实际应用潜力。
...
TL;DR: Develop a method for zero-shot synthesis of text-to-speech in under-resourced languages by adapting linguistic connections.


<details>
  <summary>Details</summary>
Motivation: To enable speech technology access for under-represented languages in India.

Method: Augment shared phone representation and modify text parsing rules to match target language phonotactics.

Result: Intelligible and natural speech was generated for Sanskrit, Maharashtrian and Canara Konkani, Maithili and Kurukh.

Conclusion: This approach reduces synthesiser overhead and enables rapid adaptation for under-represented languages.
...
<details>
  <summary>Details</summary>
Motivation: Efficient structured generations for LR(1) grammars are needed to produce outputs in specified formats.

Method: Pre$^3$ uses prefix-conditioned edges to enable ahead-of-time edge analysis and transitions from LR(1) graphs to DPDA.

Result: Pre$^3$ reduces TPOT by up to 40% and increases throughput by up to 36% in experiments.

Conclusion: Pre$^3$ improves the efficiency of LLM decoding for LR(1) grammars by optimizing the transition process.
...
TL;DR: This paper introduces Magic Mushroom, a new benchmark for evaluating Retrieval-Augmented Generation (RAG) systems' robustness against retrieval noise.


<details>
  <summary>Details</summary>
Motivation: Existing benchmarks fail to accurately simulate real-world retrieval noise, leading to unreliable robustness assessments.

Method: Defining four categories of retrieval noise and creating Magic Mushroom with 7,468 single-hop and 3,925 multi-hop question-answer pairs.

Result: Magic Mushroom shows that both large language model generators and denoising strategies need significant improvements and are highly sensitive to different noise distributions.

Conclusion: Magic Mushroom serves as a valuable resource for enhancing noise-robust RAG systems and promoting their practical application.
...
TL;DR: This study explores the influence of periodicity on information rate fluctuations in six languages, revealing consistent periodic patterns aligned with discourse structure.


<details>
  <summary>Details</summary>
Motivation: To investigate whether linguistic pressure towards periodicity affects information rate fluctuations in language, beyond syntactic, stylistic, or audience-related factors.

Method: Applying harmonic regression and introducing time scaling to detect periodicity in information contours across English, Spanish, German, Dutch, Basque, and Brazilian Portuguese texts.

Result: Consistent evidence of periodic patterns in information rate across analyzed languages, with many dominant frequencies corresponding to discourse structure.

Conclusion: Periodicity in information rate reflects meaningful linguistic organization and offers a new framework for understanding structural pressures in language.
...
TL;DR: This paper evaluates three common machine learning approaches on a large dataset of Canadian refugee decisions, finding they produce conflicting signals and fail to adequately assess fairness in legally discretionary domains.


<details>
  <summary>Details</summary>
Motivation: To examine whether statistical methods can effectively assess fairness in legal contexts shaped by discretion, normative complexity, and limited ground truth.

Method: Feature-based analysis, semantic clustering, and predictive modeling.

Result: These methods produce divergent and contradictory signals; predictive modeling often depends on contextual/procedural features rather than legal ones; semantic clustering fails to capture substantive legal reasoning.

Conclusion: Statistical fairness evaluation has limitations; current computational approaches fall short of evaluating fairness in legally discretionary domains.
...
TL;DR: Detecting hate speech is important for managing online content, but current models have trouble generalizing beyond their training data due to biases and label types. Fine-tuning models with more specific annotations still presents challenges. Training on a balanced dataset like U-PLEAD helps models generalize better while maintaining high performance.


<details>
  <summary>Details</summary>
Motivation: Current hate speech detection models struggle to generalize beyond their training data due to biases and label types.

Method: Creating U-PLEAD, a large synthetic dataset, and a new benchmark for compositional generalization to improve model training.

Result: Training on U-PLEAD combined with real data improves how well models can generalize compositionally while also achieving top performance on human-sourced data.

Conclusion: Using a balanced dataset like U-PLEAD can enhance the generalization ability of hate speech detection models without sacrificing performance.
...
TL;DR: Evaluate Multimodal Large Language Models (MLLMs) on Humanities and Social Sciences (HSS) tasks.


<details>
  <summary>Details</summary>
Motivation: Current MLLM benchmarks mainly focus on STEM, neglecting the distinct needs of HSS.

Method: Introduce HSSBench, a benchmark for evaluating MLLMs on HSS tasks in multiple languages, generated by domain experts and automated agents.

Result: HSSBench has over 13,000 samples across six categories, presenting significant challenges to current MLLMs.

Conclusion: HSSBench aims to improve MLLMs' cross-disciplinary reasoning abilities and knowledge connection across fields.
...
TL;DR: Investigate mechanisms of semantic cues shaping reasoning in large language models using comparative math problems.


<details>
  <summary>Details</summary>
Motivation: Understand how LLMs are influenced by input phrasing and semantic cues.

Method: Introduce MathComp, a benchmark evaluating 300 scenarios under 14 prompt variants across three LLM families.

Result: Found framing bias in LLMs, chain-of-thought prompting helps but varies in effectiveness, and demographic identity terms amplify directional drift.

Conclusion: Highlighting the need for framing-aware benchmarks to assess reasoning robustness and fairness in LLMs.
...
TL;DR: An unsupervised computational method is introduced to detect pivotal moments in conversations in real-time.


<details>
  <summary>Details</summary>
Motivation: To assist conversationalists in domains with highly consequential outcomes, such as mental health crisis counseling.

Method: An unsupervised computational method relying on the intuition that a moment is pivotal if our expectation of the outcome varies widely depending on what might be said next.

Result: The method aligns with human perception and conversational trajectory changes. It also explores the relation of the counselor's response during pivotal moments with the eventual outcome of the session.

Conclusion: This work provides a way to detect pivotal moments in conversations in real-time, which could be beneficial for mental health crisis counseling.
...
TL;DR: Introduce TableEval, a new benchmark for evaluating LLMs on realistic TableQA tasks including diverse table structures and cross-lingual scenarios, with a proposed SEAT evaluation framework.


<details>
  <summary>Details</summary>
Motivation: Existing TableQA benchmarks are limited by their focus on simple flat tables and suffer from data leakage. Most benchmarks are monolingual and fail to capture cross-lingual and cross-domain variability.

Method: Collect tables with various structures from four domains and in three languages. Propose SEAT, a new evaluation framework assessing the alignment between model responses and reference answers at the sub-question level.

Result: TableEval includes tables with various structures from four domains and in three languages. SEAT achieves high agreement with human judgment.

Conclusion: State-of-the-art LLMs have critical gaps in handling complex, real-world TableQA tasks. TableEval and SEAT provide insights for future improvements.
...
TL;DR: This paper introduces a method for creating large amounts of complex and diverse synthetic instructions by using attributed grounding, resulting in a dataset called SynthQuestions with over 1 million instructions. Models trained on this dataset show improved performance on various benchmarks.


<details>
  <summary>Details</summary>
Motivation: To address the limitations of existing methods for generating synthetic instructions, which either have narrow distributions or fail to produce meaningful trajectories in terms of complexity, by creating instructions that are cognitively insightful and grounded in real-world use cases.

Method: Attributed grounding, which includes a top-down attribution process to ground real instructions to users and a bottom-up synthesis process to generate situations and instructions based on web documents.

Result: A dataset of 1 million instructions named SynthQuestions, which improves model performance on several common benchmarks.

Conclusion: Models trained on the SynthQuestions dataset show leading performance on various benchmarks and this performance scales with more web corpora.
...
TL;DR: Model pruning in transformer-based language models can enhance reasoning capabilities.


<details>
  <summary>Details</summary>
Motivation: The selective pruning of certain attention heads improves reasoning performance on challenging tasks.

Method: SPRINT, a novel contrastive learning framework that dynamically selects the optimal head and layer to prune during inference by aligning question embeddings with head embeddings.

Result: Our method outperforms traditional best-of-N and random head selection strategies on the MATH500 and GSM8K datasets.

Conclusion: Selective pruning of attention heads can improve reasoning performance.
...
TL;DR: This paper proposes a multimodal model enhanced with pre-trained audio and face encoders for turn-taking prediction in human-machine interaction, which performs competitively or even better than state-of-the-art models.


<details>
  <summary>Details</summary>
Motivation: To improve turn-taking prediction performance in human-machine interaction by capturing subtle expressions using pre-trained audio and face encoders.

Method: Proposing a multimodal model enhanced with pre-trained audio and face encoders.

Result: The proposed model performed competitively or even better than state-of-the-art models on turn-taking metrics.

Conclusion: The proposed multimodal model with pre-trained audio and face encoders is effective in improving turn-taking prediction performance.
...
TL;DR: This paper presents GeoTemp, a dataset evaluating the ability of language models to jointly reason over time and space.


<details>
  <summary>Details</summary>
Motivation: Previous work on language models' logical reasoning abilities in time and space was limited to isolated tests or simple/artificial environments.

Method: The authors created GeoTemp, a dataset of 320k prompts covering 289 cities in 217 countries and 37 time zones, and evaluated eight open chat models from three different model families.

Result: Most models perform well on tasks involving only temporal knowledge, but struggle with tasks requiring connection between temporal and geographical information. Performance increases for locations with low model perplexity, and prompt formulation significantly affects performance.

Conclusion: Language models show varying levels of success in joint temporal-spatial reasoning, with performance influenced by factors such as prompt formulation and location familiarity.
...
TL;DR: This study evaluates the performance of multi-stage RAG pipelines versus simpler approaches, finding that a straightforward retrieve-then-read method (DOS RAG) performs well across various benchmarks.


<details>
  <summary>Details</summary>
Motivation: To evaluate whether multi-stage retrieval-augmented generation (RAG) pipelines still have advantages over simpler, single-stage approaches when long-context language models can process tens of thousands of tokens.

Method: Conducting a controlled evaluation for QA tasks under systematically scaled token budgets, comparing two recent multi-stage pipelines (ReadAgent and RAPTOR) against three baselines including DOS RAG.

Result: DOS RAG consistently matches or outperforms more complex methods on multiple long-context QA benchmarks.

Conclusion: DOS RAG is recommended as a simple yet strong baseline for future RAG evaluations.
...
TL;DR: 本文介绍了一种名为DynTok的新方法，用于压缩视频令牌，显著减少了令牌数量，同时保持了性能，为更高效的视频建模提供了思路。


<details>
  <summary>Details</summary>
Motivation: 典型的视频建模方法会产生大量的视觉令牌，尤其是对于长视频。为了减少计算开销，在将大量视觉上下文的信息输入到LLM骨干之前，先提取相关信息是一种实用的解决方案。

Method: 提出了一种名为DynTok的新型动态视频令牌压缩策略。该策略将视觉令牌自适应地分为组并合并每个组内的令牌，从而在信息密度低的区域实现高压缩，同时保留重要内容。

Result: 我们的方法将令牌数量减少到原始大小的44.4%，并在Video-MME上达到65.3%，在MLVU上达到72.5%。

Conclusion: 通过引入DynTok方法，我们实现了视频令牌表示的高效压缩，减少了55.6%的令牌数量，同时保持了性能的可比性。此外，这种方法还揭示了视频令牌表示中的冗余，并为设计更高效的视频建模技术提供了见解。
...
TL;DR: A new large-scale repository of manually derived word-warmth associations for over 26k English words is introduced.


<details>
  <summary>Details</summary>
Motivation: To study the development and constitution of warmth dimensions and their components trust and sociability.

Method: Manual derivation of word-warmth associations.

Result: The associations are highly reliable and can be used to study the acquisition of WCTS words with age and to enable bias and stereotype research through case studies on various target entities.

Conclusion: Words of Warmth is a valuable resource for social psychologists and is freely available online.
...
TL;DR: Investigate how large-scale models trained on massive data represent semantic features of concrete object concepts; compare image encoders (image-only, multimodal, and language-only models) using McRae norms and Binder dataset; find multimodal image encoders outperform language-only approaches.


<details>
  <summary>Details</summary>
Motivation: Compare the representation of semantic features of concrete object concepts between large-scale models and human learning grounded in sensorimotor experience.

Method: Use probing tasks to evaluate image encoders (image-only, multimodal, and language-only models) on predicting McRae norms and Binder dataset.

Result: Multimodal image encoders slightly outperform language-only approaches; image-only encoders perform comparably to language models on non-visual attributes.

Conclusion: Insights into what can be learned from pure unimodal learning and the complementarity of the modalities.
...
TL;DR: 提出了一种新的任务 QQSUM，旨在总结多样化的客户意见并量化其普遍性以有效回答用户查询。


<details>
  <summary>Details</summary>
Motivation: 现有的 PQA 系统生成的答案只包含单一的观点，无法捕捉客户意见的多样性。

Method: QQSUM-RAG 模型通过采用少量学习来联合训练一个面向关键点的检索器和一个关键点摘要生成器，从而能够捕获多样化且有代表性的观点的基于关键点的摘要。

Result: 实验结果表明，QQSUM-RAG 在文本质量和意见量化准确性方面都优于最先进的 RAG 基线。

Conclusion: QQSUM-RAG 在文本质量和意见量化准确性方面都优于最先进的 RAG 基线。
...
TL;DR: 开发了一个基于真实 EHR 数据的 Patient Simulator，用于训练和测试 AI 健康代理，结果显示其表现与真实患者情形高度一致。


<details>
  <summary>Details</summary>
Motivation: 提出一种利用现实世界患者遭遇的 Patient Simulator，提供合成测试对象以开发和测试医疗代理模型，特别是基于来自真实 EHR 数据的患者 vignettes 的 AI 健康代理。

Method: 首先，通过从真实世界的电子健康记录 (EHR) 遇见中推导出病例片段来构建逼真的临床场景。然后，在超过 500 个不同的病例片段上评估 Patient Simulator 作为真实患者遇见的 simulacrum（模拟物）。利用独立的 AI 代理进行多轮提问以获取病史，并由两名专家临床医生评估由此产生的多轮对话。

Result: 临床医生在那些相同的 97.7% 案例中评分 Patient Simulator 与病例片段一致。基于对话历史提取的案例摘要有 99% 是相关的。

Conclusion: 我们开发了一种方法，将源自真实医疗患者数据的 vignettes（病例片段）纳入构建患者对症状检查代理反应的模拟。该 Patient Simulator 的性能和一致性可用于大规模训练和测试多轮对话 AI 代理。
...
TL;DR: This study investigates mutual exclusivity (ME) bias in bilingual visually grounded speech (VGS) models compared to monolingual ones, finding that bilingual models show a weaker ME bias due to increased cross-lingual ambiguity and smaller variance in visual embeddings for familiar data.


<details>
  <summary>Details</summary>
Motivation: To understand how mutual exclusivity affects language learning in children and how this strategy is impacted by bilingualism and cross-lingual ambiguity in computational models.

Method: Training bilingual VGS models on combinations of English, French, and Dutch and comparing their ME biases with monolingual models.

Result: Bilingual models exhibit a weaker ME bias than monolingual models, partly because their combined visual embeddings for familiar data have smaller variance, leading to more confusion between novel and familiar concepts.

Conclusion: The study provides new insights into the ME bias in VGS models and highlights differences in language learning strategies between monolingual and bilingual contexts.
...
TL;DR: This paper introduces LexTime, a new dataset for evaluating large language models' ability to order events in legal language, showing that LLMs perform better on legal event ordering than narrative, and that longer input contexts and implicit events improve accuracy.


<details>
  <summary>Details</summary>
Motivation: To address the lack of expert language evaluation in existing datasets for temporal reasoning in legal texts.

Method: Introduce LexTime, a dataset of 512 instances from U.S. Federal Complaints with annotated event pairs and their temporal relations.

Result: LLMs are more accurate on legal event ordering than narrative (up to +10.5%); longer input contexts and implicit events boost accuracy, reaching 80.8% for implicit-explicit event pairs; legal linguistic complexities and nested clauses remain a challenge.

Conclusion: Specific modeling strategies are needed to enhance temporal event reasoning in legal language.
...
TL;DR: This paper proposes a new optimization process to enable more controlled knowledge editing in large language models.


<details>
  <summary>Details</summary>
Motivation: To alternate the target knowledge predicted by large language models while ensuring the least side effects on unrelated knowledge.

Method: A novel two-stage optimization process that balances the learning of the subject feature and the relation feature.

Result: The proposed method demonstrates superior performance compared to previous approaches.

Conclusion: Our approach successfully prevents knowledge editing from shortcut learning and achieves the optimal overall performance, contributing to controllable knowledge editing.
...
TL;DR: This study proposes a framework to evaluate LLM-generated counter-narratives across four dimensions, finding them often verbose and accessible only to those with college-level literacy.


<details>
  <summary>Details</summary>
Motivation: Concerns about the affective tone, accessibility, and ethical risks of automated counter-narratives for mitigating online hate speech.

Method: Proposing a framework for evaluation using three different LLMs and assessing three prompting strategies on two datasets.

Result: LLM-generated counter-narratives are often verbose and cater to college-level literacy, with emotionally guided prompts yielding more empathetic responses but safety and effectiveness concerns persist.

Conclusion: The study highlights the need for improvements in accessibility and ethical considerations when utilizing LLM-generated counter-narratives.
...
TL;DR: Introducing a new algorithm called LIBU for unlearning specific knowledge from large language models without retraining, which combines influence functions and second-order optimization.


<details>
  <summary>Details</summary>
Motivation: Removing specific knowledge from a large language model without retraining from scratch and compromising its overall utility.

Method: LIBU (LoRA enhanced influence-based unlearning)

Result: This lightweight approach is well applicable for unlearning LLMs in different kinds of task.

Conclusion: The algorithm combines classical influence functions and second-order optimization to stabilize the overall utility.
...
TL;DR: This paper explores data-centric interpretability in language models for next-word prediction, identifying support and non-support samples and revealing their roles in predictions and generalization.


<details>
  <summary>Details</summary>
Motivation: Understanding the rationale behind language model decisions remains challenging.

Method: Using the representer theorem to identify support samples promoting or deterring specific predictions.

Result: Support samples are an intrinsic property, predictable before training, while non-support samples prevent overfitting and shape generalization and representation learning.

Conclusion: Insights into the interaction between data and model decisions offer a new perspective on interpreting language model behavior.
...
TL;DR: This paper explores using explainable AI methods to make AI-generated text less detectable while also creating a robust ensemble-based detection method.


<details>
  <summary>Details</summary>
Motivation: To address the issue that AI-generated text often exhibits patterns making it easier to detect than human-written text.

Method: Training an ensemble classifier to distinguish AI-generated text from human-written text, then applying SHAP and LIME to find influential tokens and proposing four token replacement strategies.

Result: Token replacement approaches can significantly reduce a single classifier's ability to detect AI-generated text, but an ensemble classifier still performs well across different languages and domains.

Conclusion: Explainable AI methods can make AI-generated text harder to detect, but robust, ensemble-based detection strategies are necessary to counteract such manipulations.
...
TL;DR: This paper proposes HALT, a method to post-train large language models to generate content only when confident in its correctness, reducing hallucination. HALT improves the mean correctness of response fragments by 15% on average and increases correctness from 51% to 87% across four domains.


<details>
  <summary>Details</summary>
Motivation: To address the problem of hallucination in large language models, which occurs when they lack knowledge or capability.

Method: Post-train LLMs using HALT to generate content only when confident in its correctness, by producing capability-aligned post-training data that encodes what the model can and cannot reliably generate.

Result: HALT increases the mean correctness of response fragments by 15% on average, improves F1 score by 4%, and trains a reliable Llama3-70B model with correctness increased from 51% to 87% across four domains.

Conclusion: HALT effectively reduces hallucination in large language models, improving their reliability and correctness.
...
### [203] [ProRank: Prompt Warmup via Reinforcement Learning for Small Language Models Reranking](https://arxiv.org/abs/2506.03487)
...
### [204] [DiaBlo: Diagonal Blocks Are Sufficient For Finetuning](https://arxiv.org/abs/2506.03230)
...
### [205] [Comparison of different Unique hard attention transformer models by the formal languages they can recognize](https://arxiv.org/abs/2506.03370)
*Leonid Ryvkin*
...
### [206] [Adaptive Task Vectors for Large Language Models](https://arxiv.org/abs/2506.03426)
...
### [207] [Exploiting LLMs for Automatic Hypothesis Assessment via a Logit-Based Calibrated Prior](https://arxiv.org/abs/2506.03444)
...
### [208] [Prompt Candidates, then Distill: A Teacher-Student Framework for LLM-driven Data Annotation](https://arxiv.org/abs/2506.03857)
...
### [209] [Multimodal Tabular Reasoning with Privileged Structured Information](https://arxiv.org/abs/2506.04088)
...
### [210] [AmbiK: Dataset of Ambiguous Tasks in Kitchen Environment](https://arxiv.org/abs/2506.04089)
...
### [211] [Advancing Multimodal Reasoning: From Optimized Cold Start to Staged Reinforcement Learning](https://arxiv.org/abs/2506.04207)
...
### [212] [VisCoder: Fine-Tuning LLMs for Executable Python Visualization Code Generation](https://arxiv.org/abs/2506.03930)
...
### [213] [CETBench: A Novel Dataset constructed via Transformations over Programs for Benchmarking LLMs for Code-Equivalence Checking](https://arxiv.org/abs/2506.04019)
...
### [214] [Infinity Parser: Layout Aware Reinforcement Learning for Scanned Document Parsing](https://arxiv.org/abs/2506.03197)
...
### [215] [Video-Skill-CoT: Skill-based Chain-of-Thoughts for Domain-Adaptive Video Reasoning](https://arxiv.org/abs/2506.03525)
...
### [216] [BiMa: Towards Biases Mitigation for Text-Video Retrieval via Scene Element Guidance](https://arxiv.org/abs/2506.03589)
...
### [217] [VLMs Can Aggregate Scattered Training Patches](https://arxiv.org/abs/2506.03614)
...
### [218] [Mitigating Hallucinations in Large Vision-Language Models via Entity-Centric Multimodal Preference Optimization](https://arxiv.org/abs/2506.04039)
...
### [219] [MMR-V: What's Left Unsaid? A Benchmark for Multimodal Deep Reasoning in Videos](https://arxiv.org/abs/2506.04141)
...
### [220] [Tone recognition in low-resource languages of North-East India: peeling the layers of SSL-based speech models](https://arxiv.org/abs/2506.03606)
...
### [221] [mRAG: Elucidating the Design Space of Multi-modal Retrieval-Augmented Generation](https://arxiv.org/abs/2505.24073)
...
### [222] [Graph Counselor: Adaptive Graph Exploration via Multi-Agent Synergy to Enhance LLM Reasoning](https://arxiv.org/abs/2506.03939)
...
### [224] [Does Thinking More always Help? Understanding Test-Time Scaling in Reasoning Models](https://arxiv.org/abs/2506.04210)
...
### [225] [PromptCanvas: Composable Prompting Workspaces Using Dynamic Widgets for Exploration and Iteration in Creative Writing](https://arxiv.org/abs/2506.03741)
...
### [226] [Preface to the Special Issue of the TAL Journal on Scholarly Document Processing](https://arxiv.org/abs/2506.03587)
